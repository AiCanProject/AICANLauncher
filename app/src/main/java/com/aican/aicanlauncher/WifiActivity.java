...
import com.aican.aicanlauncher.databinding.ActivityWifiBinding;
import com.aican.aicanlauncher.manageWifi.WifiScanListAdapter;
...
public class WifiActivity extends Activity
    ...
    private static final String _logTag = "WifiActivity";
...
//    private Switch _mainWifiSwitch = findViewById(R.id.main_wifi_switch);
//    private ListView _mainWifiList = findViewById(R.id.main_wifi_list);
    private ActivityWifiBinding activityWifiBinding;
            ...
            if (_wifiRequestScanIntervalCounter++ >= _wifiRequestScanIntervalCount) {
                ...
                if ((_grantedPermissions.contains("android.permission.ACCESS_COARSE_LOCATION") && _grantedPermissions.contains("android.permission.ACCESS_WIFI_STATE"))) {
                    ...
                    if (!_wifiManager.startScan()) {
                        Toast.makeText(WifiActivity.this, getText(R.string.msg_wifi_scan_failed), Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    private WifiDialogActionListener _connectWifiDialogListener = new WifiDialogActionListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            Toast.makeText(WifiActivity.this, msgRsc, Toast.LENGTH_LONG).show();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityWifiBinding = ActivityWifiBinding.inflate(getLayoutInflater());
        setContentView(activityWifiBinding.getRoot());
...
//        _mainWifiList = findViewById(R.id.main_wifi_list);
        ...
        //event handlers
        activityWifiBinding.mainWifiSwitch.setOnCheckedChangeListener(this);
        activityWifiBinding.mainWifiList.setOnItemClickListener(this);

        activityWifiBinding.mainWifiList.setAdapter(_wifiScanListAdapter.getArrayAdapter());
...
//        checkPermissions();
    ...
    protected void onResume() {
        ...
        activityWifiBinding.mainWifiSwitch.setChecked(true);
        // set initial button state to actual Wi-Fi state
        activityWifiBinding.mainWifiSwitch.setChecked(_wifiManager.isWifiEnabled());
